                    ...
                    ->schema([
                        Grid::make(2)->schema([
                            ...
                            Toggle::make('requires_workflow')
                                ...
                                ->default(false)
                                ->helperText('عند التفعيل، يمر أي سجل من هذا النوع بسلسلة ترحيل بين الأدوار (مقاول/استشاري/مدير الأصل...) قبل اعتباره معتمداً نهائياً، بدلاً من اعتباره نهائياً فور الرفع.')
                                ->inline(false)
                                ->columnSpan(1),
                        ]),
                    ]),
